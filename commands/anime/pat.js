...
module.exports = {
	...
	run: async (client, message, args) => {
		if (!args.join(" ")) return message.reply("You need to specify a person to pat");
		...
		embed.setDescription(`**${member.user.username}** has been patted by **${message.author.username}**`);
