...
module.exports = {
	...
	run: async (client, message, args) => {
		if (!args.join(" ")) return message.reply("You need to specify a person to slap");
		...
		embed.setDescription(`**${member.user.username}** has been slapped by **${message.author.username}**`);
